...
from pyspark.sql.functions import current_timestamp, desc, col, to_timestamp
...
races_circruits_df = races_df.join(circuits_df, races_df.circuit_id == circuits_df.circuit_id, "inner") \
.select(races_df.race_id, races_df.race_year, races_df.race_name, races_df.race_date, circuits_df.circuit_location)

# COMMAND ----------

race_results_df = results_df.join(races_circruits_df, results_df.result_race_id == races_circruits_df.race_id) \
...
print(f"{presentation_folder_path}/")
